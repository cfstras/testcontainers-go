...
var (
	...
	BasicWaitStrategies = testcontainers.WithWaitStrategy(
		...
		// For non-linux OSes like Mac and Windows, Docker or Rancher Desktop will have to start a separate proxy process that sometimes takes a little longer to initialize.
